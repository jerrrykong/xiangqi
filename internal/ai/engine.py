...
class ChessAI:
        ...
        for lm in sorted_moves:
            ...
            if self._is_time_up():
                _log("debug", "ai_timeout_in_search",
                     depth=depth,
                     elapsed_ms=int((time.time() - self._time_start) * 1000))
                return None
    ...
    def _negamax(
        ...
        # Defensive: if best_score is still -inf, all moves were skipped.
        # Log warning and return evaluation to prevent -inf from propagating.
